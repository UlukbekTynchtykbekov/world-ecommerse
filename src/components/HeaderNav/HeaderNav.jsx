                                                    ...
                                                    <div className="mega">
                                                        <div className="container">
                                                            <div className="mega__wrapper">
                                                                ...
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Bath Accessories</a></li>*/}
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Makeup & Cosmetics</a></li>*/}
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Skin Care</a></li>*/}
                                                                {/*            <li className="mega__item"><a*/}
                                                                ...
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Soaps & Bath Bombs</a></li>*/}
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Face Masks & Coverings</a></li>*/}
                                                                {/*            <li className="mega__item"><a*/}
                                                                {/*                className="mega__link"*/}
                                                                {/*                href="">Spa Kits & Gifts</a></li>*/}
                                                                {/*        </ul>*/}
                                                                {/*    </div>*/}
                                                                {/*</div>*/}
